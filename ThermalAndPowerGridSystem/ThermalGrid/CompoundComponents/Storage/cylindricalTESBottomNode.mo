...
model cylindricalTESBottomNode "Stratified Tank Model...Geometry: Cylinder"
  ...
  parameter PerUnit Uside = 0.3, Ubottom = 0.1 "Heat transfer coefficient";
  /*parameter*/
  ...
  /* =1000*/
  Area areaBottom " Cross-sectional area of first and last segment respectively";
  Real hour;
  /*, days*/
  ...
  Interfaces.tempConnector hotIn annotation(
    Placement(visible = true, transformation(origin = {-80, 62}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-80, 62}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ThermalAndPowerGridSystem.ThermalGrid.Interfaces.tempConnector coldOut annotation(
    Placement(visible = true, transformation(origin = {-78, -46}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-80, -46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ThermalAndPowerGridSystem.ThermalGrid.Interfaces.tempConnector coldIn annotation(
    Placement(visible = true, transformation(origin = {80, -46}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {60, -46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Interfaces.tempConnector hotOut annotation(
    Placement(visible = true, transformation(origin = {80, 62}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {80, 62}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
initial equation
...
equation
  ...
  areaBottom = pi * radiusTank * radiusTank;
if mode ==1 then  
...
//    else
  QlossNode = areaBottom * Ubottom * (Tnode - Tground) + Uside * perimeterNode * (Tnode - Tground);
//    end if;
//  end for;
//for i in 1:node loop
//    if mode == 1 then
...
//end for;
  annotation(
    ...
    Diagram(graphics = {Rectangle(origin = {0.454201, 7.43058}, lineThickness = 1.25, extent = {{-99.5142, 50.4494}, {99.5142, -50.4494}}), Rectangle(origin = {0.25, 7.47}, lineColor = {17, 160, 255}, fillColor = {17, 160, 255}, fillPattern = FillPattern.HorizontalCylinder, lineThickness = 0.5, extent = {{-95.67, 47.02}, {95.67, -47.02}})}),
    Icon(graphics = {Rectangle(origin = {0.454201, 7.43058}, lineThickness = 1.25, extent = {{-99.5142, 50.4494}, {99.5142, -50.4494}}), Rectangle(origin = {0.25, 7.47}, lineColor = {17, 160, 255}, fillColor = {17, 160, 255}, fillPattern = FillPattern.HorizontalCylinder, lineThickness = 0.5, extent = {{-95.67, 47.02}, {95.67, -47.02}})}));
end cylindricalTESBottomNode;

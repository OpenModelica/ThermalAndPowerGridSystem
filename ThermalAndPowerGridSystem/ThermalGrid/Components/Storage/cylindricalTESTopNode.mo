...
model cylindricalTESTopNode "Stratified Tank Model...Geometry: Cylinder"
  ...
  Interfaces.tempConnector coldIn annotation(
    Placement(visible = true, transformation(origin = {80, -46}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {80, -46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
initial equation
...
equation
  ...
  elseif mode == 2 then
    ...
    coldOut.temp = -Tambient;
    hotOut.temp = -Tnode;
    density * areaNode * cp * der(Tnode) = -QlossNode;
/*density * Vw * cp * (inletTemperature - Tnode)*/
  end if;
//if mode ==1 then
//      inletTemperature = hotIn.temp;
//      hotOut.temp = -Tambient;
...
//    else
  QlossNode = areaTop * Utop * (Tnode - Tground) + Uside * perimeterNode * (Tnode - Tground);
//    end if;
//  end for;
//for i in 1:node loop
//    if mode == 1 then
...
//end for;
  annotation(
    ...
    Diagram(graphics = {Rectangle(origin = {0.454201, 7.43058}, lineThickness = 1.25, extent = {{-99.5142, 50.4494}, {99.5142, -50.4494}}), Rectangle(origin = {0.25, 7.47}, lineColor = {255, 2, 6}, fillColor = {255, 2, 6}, fillPattern = FillPattern.HorizontalCylinder, lineThickness = 0.5, extent = {{-95.67, 47.02}, {95.67, -47.02}})}),
    Icon(graphics = {Rectangle(origin = {0.454201, 7.43058}, lineThickness = 1.25, extent = {{-99.5142, 50.4494}, {99.5142, -50.4494}}), Rectangle(origin = {0.25, 7.47}, lineColor = {255, 2, 6}, fillColor = {255, 2, 6}, fillPattern = FillPattern.HorizontalCylinder, lineThickness = 0.5, extent = {{-95.67, 47.02}, {95.67, -47.02}})}));
end cylindricalTESTopNode;

...
extends Modelica.Icons.Package;
  ...
  ThermalAndPowerGridSystem.ThermalGrid.BaseComponents.SolarCSP solarCSP(MonthlyGlobalIrradiationData = {1e2, 3e2, 20e2, 42e2, 58e2, 78e2, 80e2, 96e2, 60e2, 38e2, 15e2, 5e2}, NumberOfCollectors = fill(1, 12))  annotation(
    Placement(visible = true, transformation(origin = {-51, 123}, extent = {{-21, -21}, {21, 21}}, rotation = 0)));
  ...
  ThermalAndPowerGridSystem.ThermalGrid.Components.Pump pumpCold1(massFlowRate = 7e-3)  annotation(
    Placement(visible = true, transformation(origin = {-176, 24}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
  ThermalAndPowerGridSystem.ThermalGrid.Components.Pump pumpBypass(massFlowRate = 7e-3)  annotation(
...
equation
  ...
  connect(portExchange1.thermalPortIn, solarCSP.heatOutput) annotation(
    Line(points = {{-48, 40}, {-50, 40}, {-50, 100}}, color = {255, 0, 0}));
...
protected
  annotation(
    Diagram(coordinateSystem(extent = {{-300, -200}, {300, 200}}), graphics = {Text(lineThickness = 20.5, extent = {{-164, -8}, {-164, -8}}, textString = "text"), Text(origin = {-125, 175}, lineThickness = 20.5, extent = {{-41, 13}, {41, -13}}, textString = "bypassControl"), Text(origin = {-135, 53}, lineThickness = 20.5, extent = {{-37, 13}, {37, -13}}, textString = "solarControl"), Text(origin = {-131, -67}, lineThickness = 20.5, extent = {{-37, 13}, {37, -13}}, textString = "boilerControl"), Text(origin = {-135, 53}, lineThickness = 20.5, extent = {{-37, 13}, {37, -13}}, textString = "solarControl")}),
